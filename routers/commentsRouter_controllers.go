...
func init() {
    ...
    beego.GlobalControllerRouter["simple-store-api/controllers:UserController"] = append(beego.GlobalControllerRouter["simple-store-api/controllers:UserController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
